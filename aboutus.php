...
<body>
		...
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>Small Size Bed</label> <label style = "color:red;">LKR. 2,000.00</label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label style = "color:red;">LKR. 800.00</label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>1 Medium Size Bed</label> <label style = "color:red;">LKR. 2,400.00 </label></center>
				</div>
				<br style = "clear:both;"/>
				<br />
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>2 Medium Size Bed</label> <label style = "color:red;">LKR. 2,800.00 </label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>Matrimonial</label> <label style = "color:red;">LKR. 3,800.00 </label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>Matrimonial</label> <label style = "color:red;">LKR. 4,000.00 </label></center>
				</div>
				<br style = "clear:both;"/>
				<br />
				<br />
	...
	<div style = "text-align:right; margin-right:10px;" class = "navbar navbar-default navbar-fixed-bottom">
		<label>&copy; Copyright Tripify 2023 </label>
	</div>
</body>
